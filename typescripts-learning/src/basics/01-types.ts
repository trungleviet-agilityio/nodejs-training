...
const inferredString = "Hello World"; // TypeScript infers this as string
const inferredNumber = 42; // TypeScript infers this as number
const inferredArray = [1, 2, 3, 4, 5]; // TypeScript infers this as number[]
...
const unknownValue: unknown = "This is safer than any";
